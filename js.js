...
//////////////////////////////////////////////////////////// show score all ////////////////////////////////////////////////////////////////////
         showscoreall();
            function showscoreall(){
             ...
             '<div class="centertitle"><h2 style="color: rgb(75, 75, 75)">---------- Set: '+ count +' ----------</h2></div>'+
        '<div id="showscorediv">'+
            '<div class="scoreall">'+
                '<div class="scorename">'+
...
////////////////////////////////////////////////////////////////////////  show max score   ////////////////////////////////////////////////////////////////////////////////
        ...
        function p1(i){
            if(points[i] == scorePlayer1){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer1){ i++; break;}
                } 
        ...
        function p2(i){
            if(points[i] == scorePlayer2){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer2){ i++;  break;}
                } 
        ...
        function p3(i){
            if(points[i] == scorePlayer3){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer3){ i++;  break;}
                }  
        ...
        function p4(i){
            if(points[i] == scorePlayer4){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer4){ i++;  break;}  
                }  
        ...
        function p5(i){
            if(points[i] == scorePlayer5){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer5){ i++;  break;}
                }  
        ...
        function p6(i){
            if(points[i] == scorePlayer6){
                for(var j = 0; j < 6; j++){
                    if(namescore[j] == nameplayer6){i++; break;}
                } 
...
////////////////////////////////////////////////////////////////////////  show error score   ////////////////////////////////////////////////////////////////////////////////
        ...
        pointsE.sort(function(a, b){return b - a});
        for(var i = 0; i< 6; i++){
            p6E(i);
            p5E(i);
            p4E(i);
        ...
        function p1E(i){
            if(pointsE[i] == scorePlayer1E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer1){ i++; break;}
                } 
        ...
        function p2E(i){
            if(pointsE[i] == scorePlayer2E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer2){ i++;  break;}
                } 
        ...
        function p3E(i){
            if(pointsE[i] == scorePlayer3E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer3){ i++;  break;}
                }  
        ...
        function p4E(i){
            if(pointsE[i] == scorePlayer4E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer4){ i++;  break;}  
                }  
        ...
        function p5E(i){
            if(pointsE[i] == scorePlayer5E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer5){ i++;  break;}
                }  
        ...
        function p6E(i){
            if(pointsE[i] == scorePlayer6E){
                for(var j = 0; j < 6; j++){
                    if(namescoreE[j] == nameplayer6){i++; break;}
                } 
